...
%else
mkdir -p $RPM_BUILD_ROOT/usr/lib/oracle/18.5/client/lib/network/admin
...
%{_bindir}/sqlplus
%{_libdir}/oracle
/usr/lib/oracle/18.5/client64/lib/network/admin/sqlnet.ora
/usr/lib/oracle/18.5/client64/lib/network/admin/sqlnet.ora
%else
/usr/lib/oracle/18.5/client/lib/network/admin/sqlnet.ora
%endif
